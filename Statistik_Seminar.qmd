...
→ r = 0.81, p < 0.001: starker positiver Zusammenhang — plausibel!
...
- **Nicht monoton**: Die Richtung wechselt irgendwo
  - Beispiel: Zufriedenheit steigt bis zur Mitte eines Films, dann fällt sie wieder
...
## Demo: Spearman-Korrelation — Bücher-Datensatz

Buchbewertungen sind ordinal (1–10) — Spearman ist hier besser geeignet als Pearson:

```r
cor.test(books$Age, books$`Book-Rating`, method = "spearman")
```

→ Notebook

- Hängt das Alter der Lesenden mit der Bewertung zusammen?
- Wie unterscheidet sich das Ergebnis von Pearson?
