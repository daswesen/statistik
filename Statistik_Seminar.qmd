...
| IQR | `IQR(data)` | Mittlere 50% der Daten |
...
- Berechnen Sie Spannweite, IQR und Standardabweichung der Bewertungen (`Book-Rating`)
- Wie stark streuen die Bewertungen je nach Altersgruppe der Nutzenden?
- Erstellen Sie einen Boxplot der Bewertungen
- Erstellen Sie einen Violin Plot, der Altersgruppen vergleicht
- Was fällt Ihnen auf?
