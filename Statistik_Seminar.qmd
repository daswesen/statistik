...
## Live-Demo: Zentraler Grenzwertsatz
...
# Mehr Platz für den Titel durch Anpassung der Ränder
par(mar=c(4, 4, 3, 2) + 0.1)  # unten, links, oben, rechts

plot(x, y2, type="l", lwd=2, col="red", 
     main="Normalverteilungen", xlab="x", ylab="Dichte",
     # Plot-Höhe reduzieren, damit mehr Platz für Titel bleibt
     ylim=c(0, max(y1)*1.1))  
lines(x, y1, lwd=2, col="blue")
lines(x, y3, lwd=2, col="green")

# Legend weiter nach unten verschieben
legend("topright", inset=c(0.05, 0.05),
       legend=c("σ = 0.5", "σ = 1", "σ = 2"),
...
-   **Aufgabe**: 
    1. Untersuchen Sie die Verteilung der Ankunftsverspätungen
    2. Prüfen Sie, ob die Verspätungen normalverteilt sind
    3. Berechnen Sie die Wahrscheinlichkeit für Verspätungen > 30 Minuten
    4. Visualisieren Sie verschiedene Verteilungsannahmen
