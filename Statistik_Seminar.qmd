...
-   Lage- und Streuungsmaße berechnen und interpretieren
-   Den Unterschied zwischen Mittelwert und Median erklären
-   Verteilungen anhand von Histogramm und Boxplot beurteilen
...
![](images/einkommensschichtung.png) \## Im Durchschnitt haben Sie...
...
-   Verschiedene Dateiformate kennen und einordnen
...
-   5 Datensätze: `flights`, `planes`, `airlines`, `airports`, `weather`
-   Laden: `install.packages("nycflights23")` → `library(nycflights23)`
-   Reale Flugdaten – ideal für komplexere Transformationen
