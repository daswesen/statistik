...
## Erste Visualisierung: Streudiagramm mit Regressionslinie
...
- Beispiel: R² = 0.72 → 72 % der Mietunterschiede durch Fläche erklärbar
...
| Wahrscheinlichkeit \\(p\\) | Odds \\(p / (1 - p)\\) | Log-Odds \\( \log(p / (1 - p)) \\) |
|----------------------------|-------------------------|------------------------------------|
| 0.10                       | 0.111                   | –2.20                              |
| 0.50                       | 1.000                   |  0.00                              |
| 0.90                       | 9.000                   |  2.20                              |
