...
- Präsentation mit Quellenangaben nach Referat in Moodle hochladen
- Termine für Referate (nach 9. Sitzung) bitte ins Forum posten
...
-   R und RStudio installieren und bedienen
-   Grundlegende Datentypen und -strukturen in R kennen
-   Erste eigene Berechnungen und Funktionen ausführen
-   Einen Datensatz in R laden und erkunden
...
-   Daten mit tidyverse-Funktionen transformieren und aggregieren
-   Datensätze importieren und verbinden (Joins)
-   Typische Datenfehler erkennen und beheben
-   Einen eigenen Datensatz für die Bachelorarbeit aufbereiten
